...
## 開発手順
現在の工程: 2. 調査書レビュー（工程が承認されたら、Claude がこの行を次の工程に更新する）
...
| 13 | リリース準備 | docs/06-release.md（手順書・確認項目）、docs/release-notes.md |
| 14 | リリースレビュー | docs/reviews/06-release-review.md |
| 15 | 公開と公開後の確認 | 公開された URL。確認結果は docs/reviews/06-release-review.md に追記する |
...
### git
- このディレクトリはまだ git リポジトリではない。実装（工程 11）に入る前に、ユーザーの了承を得て `git init` する。
...
| 13〜15 リリース | 適用しない | ビルドの設定と手順書の作成のため |
